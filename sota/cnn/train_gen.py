...
from sota.cnn.model import GenNetwork, GenNetworkV2, Network
from torch.utils.tensorboard import SummaryWriter
from collections import namedtuple
from spaces import spaces_dict

parser = argparse.ArgumentParser("cifar")
parser.add_argument('--data', type=str, default='../../_dataset',
...
parser.add_argument('--auxiliary', default=True, help='use auxiliary tower')
parser.add_argument('--auxiliary_weight', type=float, default=0.4, help='weight for auxiliary loss')
parser.add_argument('--augment', type=bool, default=False)
parser.add_argument('--cutout', default=True, help='use cutout')
...
parser.add_argument('--arch', type=str, default='No', help='which architecture to use')
...
if args.resume_epoch > 0:  # do not delete dir if resume:
    ...
    args.save = os.path.join(args.save, f"{time.strftime('%Y-%m-%d', time.localtime())}")
    args.save = os.path.join(args.save, f"{time.strftime('%H-%M-%S', time.localtime())}")
    args.save = os.path.join(args.save, f'{os.getpid()}')
