...
sys.path.insert(0, '../../')
from sota.cnn.model_search import GenNetwork


class GenDartsNetworkProj(GenNetwork):
    def __init__(self, C, num_classes, layers, criterion, primitives, args, data,
                 steps=4, multiplier=4, stem_multiplier=3, drop_path_prob=0.0):
        super(GenDartsNetworkProj, self).__init__(C, num_classes, layers, criterion, primitives, args, data,
