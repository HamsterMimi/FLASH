...
if __name__ == '__main__':
    s0 = torch.randn(size=(1, 3, 32, 32))
    s1 = torch.randn(size=(1, 3, 32, 32))
    cell = GenCell(steps=4, multiplier=4, C_prev_prev=3, C_prev=3, C=3, reduction=False, reduction_prev=False, data1=s0,
                   data2=s1)
